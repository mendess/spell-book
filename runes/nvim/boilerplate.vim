...
fu! BoilerplateC()
    if line('$') == 1
        if expand("%:e") == "h" || expand("%:e") == "hpp"
            ...
            call append(2, "")
            call append(3, "int main(int argc, char const* const* argv){")
...
fu! BoilerplateCPP()
    if line('$') == 1
        if expand("%:e") == "h" || expand("%:e") == "hpp"
            ...
            call append(1, "")
            call append(2, "auto main(int argc, char const* const* argv) -> int {")
...
fu! BoilerplateJava()
    if line('$') == 1
        ...
        call append(3, "    public static void main(String[] args) throws Exception {")
